...
!!!!USERS!!!!
CREATE TABLE IF NOT EXISTS `simulado`.`users` (
...
!!!!PRODUTOS!!!!
CREATE TABLE IF NOT EXISTS `simulado`.`produtos` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
!!!!MOVIMENTACAO!!!!!
CREATE TABLE IF NOT EXISTS `simulado`.`movimentacaos` (
  `id` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `movimentacaos_produto_id_foreign`
    ...
    REFERENCES `simulado`.`produtos` (`id`),
  CONSTRAINT `movimentacaos_user_id_foreign`
    FOREIGN KEY (`user_id`)
    REFERENCES `simulado`.`users` (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 4
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci